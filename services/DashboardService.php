...
class DashboardService {
    ...
    public function getWeeklyReportStats() {
        ...
        $response = apiRequest(API_REPORTS . '/statistics?period=weekly', 'GET', null, $headers);

        // Jika endpoint statistik mingguan tidak tersedia, coba endpoint umum
        if (!$response['success'] || !isset($response['data'])) {
            $response = apiRequest(API_REPORTS_STATISTICS, 'GET', null, $headers);
        }
    ...
    public function getMonthlyReportStats() {
        ...
        $response = apiRequest(API_REPORTS . '/statistics?period=monthly', 'GET', null, $headers);
