...
<body class="with-welcome-text">
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-sm-12">
              ...
              <p class="text-muted">Ini adalah dashboard khusus untuk admin</p>
            </div>
          </div>


          <?php if (!$stats['success'] && !empty($stats['errors'])): ?>
          <div class="row">
                ...
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-center">
                    <div>
                      ...
                      <h3 class="font-weight-bold mb-0"><?php echo $stats['data']['laporan_baru'] ?? 0; ?></h3>
                    </div>
                    <div class="icon-lg">
                ...
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-center">
                    <div>
                      ...
                      <h3 class="font-weight-bold mb-0"><?php echo $stats['data']['laporan_ditangani'] ?? 0; ?></h3>
                    </div>
                    <div class="icon-lg">
          ...
          <?php if (isset($weeklyStats) && isset($monthlyStats) && $weeklyStats['success'] && $monthlyStats['success']): ?>
          <div class="row mt-4">
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Setup BMKG auto-refresh if data exists
        if (dashboardData.bmkgData && dashboardData.bmkgData.success) {
            setInterval(() => {
                // BMKG data refresh logic (silent)
                console.log("🔄 BMKG data refresh triggered");
            }, 300000); // 5 minutes
        }
