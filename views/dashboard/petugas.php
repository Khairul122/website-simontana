        ...
        <div class="content-wrapper">
          ...
          <div class="row mt-4">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex justify-content-between">
                    <p class="card-title">Laporan Ditangani</p>
            ...
            <div class="col-md-4 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <div class="d-flex justify-content-between">
                    <p class="card-title">Laporan Selesai</p>
                    <div class="text-info">
                      <i class="mdi mdi-arrow-up-bold"></i>
                    </div>
                  </div>
                  <h4 class="font-weight-bold">28</h4>
                  <div class="progress progress-md">
            ...
            <div class="col-md-4 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <div class="d-flex justify-content-between">
                    <p class="card-title">Laporan Terbuka</p>
          ...
          <div class="row mt-4">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Status Penanganan Minggu Ini</h4>
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Jenis Bencana Ditangani</h4>
          ...
          <div class="row mt-4">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Laporan yang Perlu Ditangani</h4>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><label class="badge badge-info">Verifikasi</label></td>
                          <td>2025-06-15</td>
                          <td>
                            <button class="btn btn-sm btn-primary">Tangani</button>
                          </td>
                        </tr>
                        <tr>
                          <td>102</td>
