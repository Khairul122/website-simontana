        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-sm-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"><?php echo $isEdit ? 'Edit' : 'Tambah'; ?> Desa</h4>
                  <p class="card-description"><?php echo $isEdit ? 'Edit' : 'Tambah'; ?> data desa baru</p>
                  
                  <form action="index.php?controller=Wilayah&action=<?php echo $isEdit ? 'updateDesa&id=' . $desa['id'] : 'storeDesa'; ?>" method="POST">
